  ...
  <div class="advert-scope">
    <div class="content">
      <div class="d-flex align-items-center">
        ...
        <div class="new-tag">
          <span v-if="throwType !== 'A'" class="fixed">定投</span>
          <span v-else class="open">公开</span>
        </div>
      </div>
      <div class="student-scope-continer">
        <div>
          <el-radio-group v-model="throwType">
                  ...
                  <div class="newTag">
                    <span
                      ...
                      >{{ item2.name
                        ...
                        "
                        style="padding-left: 6px;color: #C0C4CC;cursor: pointer"
                        class="el-icon-error"
                      ></i
                    ></span>
                  </div>
          ...
          >
            <template>
              <div
                class="d-flex justify-content-between align-items-center mb-15"
              >
                <el-dropdown
                  v-show="false"
                  trigger="click"
...
<script src="./advert-scope.ts"></script>

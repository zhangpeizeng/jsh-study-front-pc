    ...
    <div class="content" style="padding-bottom:15px;">
      ...
      <el-row type="flex" align="middle" :gutter="10" class="el-row">
        ...
        <el-col :span="8" class="text-content">
          <span class="content-span">直播课</span>
        </el-col>
      </el-row>
      <el-row type="flex" align="middle" :gutter="10" class="el-row">
        <el-col :span="2" class="text-right">
        ...
        <el-col :span="5" class="text-content">
          <div class="d-flex align-items-center" style="width: 270px">
            <div
              class="uncheck"
              :class="{ 'checked-btn': courseLiveType === 'PC' }"
              @click="selectLive('PC')"
            >
              PC直播
            </div>
            <div
              class="uncheck"
              :class="{ 'checked-btn': courseLiveType === 'APP' }"
              style="margin-left:10px"
              @click="selectLive('APP')"
            >
              APP直播
            </div>
          </div>
        ...
        <el-col :span="5" class="text-content word-break">
          <img src="../../../assets/images/icon-tips.png" class="icon-tip" />
          <el-tooltip placement="top-start">
            <div slot="content">
              <div class="prompt">
                课程一旦上架无法更改，其中PC直播讲师可通过电脑演示文档、白板、指定学员连麦等；
              </div>
              <div class="prompt">
                APP直播更灵活，仅可查看留言，无其他功能，请依据讲师直播场景进行合理选择。
              </div>
            </div>
            <span class="prompt color-red">
              课程一旦上架无法更改，其中PC直播讲师可通过电脑演示文
            </span>
          </el-tooltip>
        </el-col>
      </el-row>
        ...
        <el-col :span="8" class="text-content">
          <div class="text-img-content">
            <div
              ...
              :key="index"
            >
              <img :src="item.imgSrc" @click="layoutClick(item)" />
            </div>
          </div>
      ...
      <div :class="{ tierBorder: testStatus === 1 }">
        ...
        >
          ...
          >
            ...
            <el-col :span="7.5" class="text-content" v-show="testStatus === 1">
              <el-date-picker
      ...
      <div :class="{ tierBorder: taskStatus === 1 }">
        ...
        >
          ...
          <el-row
            ...
            :gutter="10"
            class="el-row"
            v-show="taskStatus === 1 && pkStatus === 1"
          >
            <el-col :span="2" class="text-right">
              <span>PK时间</span>
            </el-col>
...
<script lang="ts" src="./add-live-course.ts"></script>
    ...
    .el-row {
      ...
      .text-content {
        ...
        .checked-btn::after {
          ...
          width: 16px;
          height: 16px;
          background: url("../../../assets/images/checked-icon.png") no-repeat
            center;

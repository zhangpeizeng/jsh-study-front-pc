    ...
    <div class="content" style="padding-bottom:15px;">
      ...
      <el-row type="flex" align="middle" :gutter="10" class="el-row">
        ...
        <el-col :span="8" class="text-content">
          <span class="content-span">系列课</span>
        </el-col>
      </el-row>
      <el-row
        type="flex"
    ...
    <div class="content pt-content">
      ...
      <div style="padding: 0 20px">
        <el-table :data="tableData" style="width: 100%">
          ...
          <el-table-column label="课时名称" min-width="150px">
            <template slot-scope="scope">
              <span
          ...
          <el-table-column label="课程状态" min-width="100px">
            <template slot-scope="scope">
              <span v-if="scope.row.courseType === '5'">-</span>
              <span v-else-if="scope.row.deleteFlg === 1">已删除</span>
      ...
      <div :class="{ tierBorder: testStatus === 1 }">
        ...
        >
          ...
          <el-row
            ...
            :gutter="10"
            class="el-row"
            v-if="testStatus === 1 && fillTestStatus === 1"
          >
            <el-col :span="2" class="text-right">
              <span>补考时间</span>
            </el-col>
    ...
    <div class="content pt-content">
      ...
      <div :class="{ tierBorder: taskStatus === 1 }">
        <el-row
          ...
          v-show="taskStatus === 1"
        >
          <el-col v-show="taskStatus === 1" :span="2" class="text-right">
            <span>提交时间</span>
          </el-col>
        ...
        >
          ...
          >
            <el-col v-show="pkStatus === 1" :span="2" class="text-right">
              <span>PK时间</span>
            </el-col>
...
<script lang="ts" src="./add-series-course.ts"></script>

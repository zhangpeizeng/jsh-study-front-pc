  ...
  <div class="container-box" v-loading="loading">
    <div class="content">
      ...
      >
        ...
        <el-col :span="8">
          ...
          >
            <div class="text-text" v-if="classClassifyName2 !== ''">
              <span class="text-title" style="margin-right: 10px;">
                {{ classClassifyName2 }}
              </span>
            </div>
      ...
      <el-row
        ...
        :gutter="10"
        class="el-row"
        v-if="studyTerminalAndClassifyList.length === 3"
      >
        <el-col :span="2" class="text-right">
          <span class="text-title"></span>
        </el-col>
        ...
        <el-col :span="8">
          ...
          >
            <div class="text-text" v-if="classClassifyName3 !== ''">
              <span class="text-title" style="margin-right: 10px;">
                {{ classClassifyName3 }}
              </span>
            </div>
          </el-tooltip>
          <span v-if="classClassifyName3 == null"> - </span>
        </el-col>
      </el-row>
    ...
    <div class="content pb-20">
      ...
      <div class="footer-bottom-container">
        <template>
          <el-button size="mini" @click="closeto()" class="close"
            >关闭</el-button
          >
        </template>
      </div>
...
<script lang="ts" src="./course-detail.ts"></script>
<style lang="scss">
.course-description {
  .ql-align-center {
    text-align: center;

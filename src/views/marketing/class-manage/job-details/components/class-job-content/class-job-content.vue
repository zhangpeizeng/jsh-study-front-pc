  ...
  <div>
    <div class="table-body">
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <span>{{ scope.row.submitTime | date("yyyy-MM-dd hh:mm") }}</span>
          </template>
        </el-table-column>
        ...
        >
          <template slot-scope="scope">
            <span>{{ scope.row.correctTime | date("yyyy-MM-dd hh:mm") }}</span>
          </template>
        </el-table-column>
...
<script lang="ts" src="./class-job-content.ts"></script>
<style lang="scss">
.job-drawer {
  .el-drawer__header {
    color: #303133;

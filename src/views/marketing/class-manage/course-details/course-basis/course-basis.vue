<template>
  <div class="container-box" v-loading="loading">
    <div class="content">
      <el-row type="flex" align="top" :gutter="10" class="el-row">
        <el-col :span="2" class="text-right">
          <span class="text-title">课程内容:</span>
        </el-col>
        <el-col :span="20">
          <span class="text-title">{{
            Number(detail.coursesType) === 1 ? "上传资料" : "选择已有课程"
          }}</span>
        </el-col>
      </el-row>
      <el-row type="flex" align="top" :gutter="10" class="el-row">
        ...
        <el-col :span="20">
          <span class="text-title">{{ detail.coursesName }}</span>
        </el-col>
      </el-row>
      <el-row type="flex" align="top" :gutter="10" class="el-row">
        <el-col :span="2" class="text-right">
        ...
        <el-col :span="20">
          <span class="text-title">
            {{ detail.coursesStartTime | date("yyyy-MM-dd hh:mm") }} -
            {{ detail.coursesEndTime | date("yyyy-MM-dd hh:mm") }}</span
          >
        </el-col>
      </el-row>
      <el-row
        v-if="detail.courseType === '6'"
        type="flex"
        align="top"
        :gutter="10"
        class="el-row"
      >
        ...
        <el-col :span="20">
          <span class="text-title">{{
            detail.lecturerLibraryName ? detail.lecturerLibraryName : "-"
          }}</span>
        </el-col>
      </el-row>

      <div v-if="courseType !== '6'">
    ...
    <div class="content" v-if="courseType === '1' || courseType === '6'">
...
<script lang="ts" src="./course-basis.ts"></script>

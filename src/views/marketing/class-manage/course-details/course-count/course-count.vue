  ...
  <div style="padding: 0 24px; background-color: #ffffff">
    <div class="content-top">
      <div class="course-time" style="margin-bottom: 15px;">
        ...
        <div class="course-type" v-if="detail.courseTypeName">
    ...
    <div>
      ...
      <el-tabs v-model="customerActiveName" @tab-click="handleClick">
        <el-tab-pane label="已学习" name="already">
          <div class="table-body">
              ...
              <div class="student-class clearfloat">
                <div style="float: left;">
                  <el-form-item label="中心">
                    ...
                    >
                      <el-option
                        v-if="gmList.tagList && gmList.tagList.length > 0"
                        label="全选"
                        value="all"
                      ></el-option>
                      <el-option
                  ...
                  <el-form-item label="产业">
                    ...
                    >
                      <el-option
                        v-if="
                          productList.tagList && productList.tagList.length > 0
                        "
                        label="全选"
                        value="all"
                      ></el-option>
                  ...
                  <el-form-item label="学习状态">
                    <el-select v-model="studyStatus" placeholder="请选择">
                      <el-option
            ...
            >
              ...
              >
                <template slot-scope="scope">
                  <div v-if="scope.row.studyStatus === 1">已学完</div>
                  <div v-if="scope.row.studyStatus === 2">学习中</div>
                  <div v-if="scope.row.studyStatus === 3">提前学习</div>
                  <div v-if="scope.row.studyStatus === 4">超期学习</div>
                </template>
              </el-table-column>
              <el-table-column
                prop="cusStudyTime"
        ...
        <el-tab-pane label="未学习" name="nostudy">
          <courseNostudy
            :detail="detail"
            :classid="classid"
            :idClass="idClass"
        ...
        <el-tab-pane
          v-if="Number(detail.coursesType) !== 1 && isShowExam"
          label="已考试"
          name="examComplete"
        >
          <examComplete
            :classId="classid"
            :idClass="idClass"
            :studyTerminals="terminalCode"
          ></examComplete>
        </el-tab-pane>
        <el-tab-pane
          v-if="Number(detail.coursesType) !== 1 && isShowAssignment"
          label="作业批改情况"
...
<script lang="ts" src="./course-count.ts"></script>

...
export default class messageManagement extends Vue {
  ...
  getCorrections() {
    ...
    Http.post(MarkeTing.classListhomeworkinfo, params)
      .then(resp => {
  ...
  onExportSellerAlready(): void {
    ...
    Http.post(Exchange.classexporthomeworkinfo, obj)
      .then(resp => {
  ...
  checkDownloadSellerAlreadyStatus(taskId: string): void {
    let owner = this;
    Http.get(Exchange.classexporthomeworkinfostatus, { taskId: taskId })
      .then(resp => {
  ...
  downloadSellerAlreadyFile(taskId: string): void {
    let owner = this;
    Http.get(
      Exchange.classexporthomeworkinfotask,
      { taskId: taskId },
      {
        responseType: "blob",
        headers: {}

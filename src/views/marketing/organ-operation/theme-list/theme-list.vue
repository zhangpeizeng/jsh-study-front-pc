<template>
  <div class="theme-list">
    <div>
      <!--      <el-tabs v-model="labelCode" type="card" @tab-click="handleClick">-->
      <!--        <el-tab-pane label="客户端" name="1"></el-tab-pane>-->
      <!--        <el-tab-pane label="员工端" name="2"></el-tab-pane>-->
      <!--        <el-tab-pane label="直销员端" name="3"></el-tab-pane>-->
      <!--      </el-tabs>-->
      <el-tabs
        v-model="labelCode"
        type="card"
    ...
    <div class="body">
      ...
      >
        <el-table-column type="index" width="300" label="分类排序">
...
<script lang="ts" src="./theme-list.ts"></script>
<style lang="scss">
.theme-list {
  .el-tabs__item {

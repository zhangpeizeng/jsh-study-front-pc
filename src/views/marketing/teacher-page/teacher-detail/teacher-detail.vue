        ...
        <div style="width:60%">
          ...
          <el-row type="flex" align="middle" :gutter="11" class="el-row">
            ...
            <el-col :span="10" class="text-content">
              ...
              <span v-for="(item, index) in micro" :key="index">
                <span v-if="index > 0">,</span>{{ item }}
              </span>
            </el-col>
          </el-row>
          <el-row type="flex" align="middle" :gutter="11" class="el-row">
            ...
            <el-col :span="10" class="text-content">
              <span v-for="(item, index) in studyTerminals" :key="index">
                <span v-if="index > 0">/</span>{{ item }}
              </span>
            </el-col>
          </el-row>
          ...
          <el-row type="flex" align="top" :gutter="11" class="el-row">
            ...
            <el-col :span="11" class="text-content">
              <img :src="lecturerImg" style="width: 120px;height: 160px;" />
            </el-col>
          </el-row>
        </div>
        <div
...
<script lang="ts" src="./teacher-detail.ts"></script>

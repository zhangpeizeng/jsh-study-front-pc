    ...
    <div class="content" style="padding-bottom:15px;">
      ...
      <el-row type="flex" align="middle" :gutter="10" class="el-row">
        ...
        <el-col :span="8" class="text-content">
          <span class="content-span">研讨课</span>
        </el-col>
      </el-row>
      <el-row
        type="flex"
      ...
      <el-row type="flex" align="middle" :gutter="10" class="el-row">
        <el-col :span="2" class="text-right">
          <span class="content-span">连麦人数</span>
        </el-col>
        <el-col :span="8" class="text-content">
          <el-select
            v-model="peopleCount"
          ...
          >
            <el-option
              v-for="item in peopleCountList"
              :key="item.peopleCount"
              :label="item.peopleCountName"
...
<script lang="ts" src="./add-discussion-course.ts"></script>

    ...
    <div class="content" style="padding-bottom:0px;">
      ...
      <el-row type="flex" align="middle" :gutter="10" class="el-row">
        ...
        <el-col :span="8" class="text-content">
          <span class="content-span" v-if="detailObj.throwTerminal == 1">
            客户端
          </span>
          <span class="content-span" v-if="detailObj.throwTerminal == 2">
            员工端
          </span>
          <span class="content-span" v-if="detailObj.throwTerminal == 3">
            直销员端
          </span>
          <span class="content-span" v-if="detailObj.throwTerminal == 4">
            售后端
          </span>
        </el-col>
      </el-row>
      ...
      <el-row type="flex" align="top" :gutter="10" class="el-row">
        ...
        <el-col :span="15" class="text-content">
          <img :src="detailObj.advertUrl" style="width:300px;height:128px" />
        </el-col>
      </el-row>
      <el-row type="flex" align="middle" :gutter="10" class="el-row">
        <el-col :span="2" class="text-right">
        ...
        <el-col :span="7.5" class="text-content">
          <span class="content-span">
            {{ detailObj.startDate | date("yyyy-MM-dd hh:mm") }}至{{
      ...
      <el-row type="flex" align="middle" :gutter="10" class="el-row">
        ...
        <el-col :span="10" class="text-content">
          <span class="content-span" v-if="detailObj.advertJumpType == 1">
            无
          </span>
          <span class="content-span" v-if="detailObj.advertJumpType == 2">
            课程
          </span>
          <span class="content-span" v-if="detailObj.advertJumpType == 3">
            运营主题
          </span>
          <span class="content-span" v-if="detailObj.advertJumpType == 4">
            自定义内容
          </span>
        </el-col>
      </el-row>
      <el-row
        ...
        :gutter="10"
        class="el-row"
        v-show="detailObj.advertJumpType === 4"
      >
        <el-col :span="2" class="text-right">
          <span></span>
        </el-col>
      ...
      <el-row
        ...
        :gutter="10"
        class="el-row"
        v-show="detailObj.advertJumpType === 2"
      >
        <el-col :span="2" class="text-right">
          <span></span>
        </el-col>
      ...
      <el-row
        ...
        :gutter="10"
        class="el-row"
        v-show="detailObj.advertJumpType === 3"
      >
        <el-col :span="2" class="text-right">
          <span></span>
        </el-col>
...
<script lang="ts" src="./banner-detail.ts"></script>

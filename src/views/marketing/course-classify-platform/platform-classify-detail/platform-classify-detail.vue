  ...
  <div class="brand-list">
    ...
    <div v-if="tabsName == '1'">
      ...
      <el-row
        ...
        :gutter="10"
        class="el-row"
        v-if="detailObj.classifyParentIdList.length == 1"
      >
        <el-col :span="2" class="text-right">
          <span class="text-title">所属部门:</span>
        </el-col>
        <el-col :span="8" class="text-content">
          <span class="content-span">
            {{ detailObj.departmentName }}
          </span>
        </el-col>
      </el-row>
      <el-row
      ...
      >
        <el-col :span="2" class="text-right">
          <span class="text-title">管理员:</span>
        </el-col>
        <el-col :span="3" class="text-content">
          <div
            class="content-span"
            v-for="(item, index) in detailObj.lecturerDtos"
            :key="index"
            style="margin-bottom: 5px"
          >
            {{ item.lecturerName }}({{ item.employeeId }})
          </div>
        </el-col>
        <el-col :span="8" class="text-content">
      ...
      <el-row type="flex" align="top" :gutter="10" class="el-row">
        ...
        <el-col :span="8" class="text-content">
          <span class="content-span" v-if="detailObj.remark">
            {{ detailObj.remark }}
          </span>
          <span class="content-span" v-else>
            -
          </span>
        </el-col>
      </el-row>
...
<script lang="ts" src="./platform-classify-detail.ts"></script>

    ...
    >
      ...
      <div class="tree-list" v-for="(item, index) in classifyList" :key="index">
        <div>
          ...
          >
            <div class="tree-flex" style="padding:4px 0">
              <div style="width:23%;margin-left:2%" class="tree-flex">
                <img
                  src="../../../../assets/images/tree-open.png"
                  style="width:12px;height:12px;margin-right:12px"
                  v-show="item1.children.length > 0 && !item1.openFlag"
                  @click="item1.openFlag = !item1.openFlag"
                />
                <img
                  src="../../../../assets/images/tree-close.png"
                  style="width:12px;height:12px;margin-right:12px"
            ...
            <div
              ...
              :key="index2"
              v-show="item1.openFlag"
            >
              <div class="tree-flex" style="padding:4px 0">
                <div style="width:20%;margin-left:5%" class="tree-flex">
                  <img
                    src="../../../../assets/images/tree-third.png"
                  ...
                  <img
                    ...
                    style="width:12px;height:12px;"
                    v-show="stopFlag"
                    @click="thirdUp(item2, index2, index, index1)"
                  />
                  <img
                    src="../../../../assets/images/tree-down.png"
                    style="width:12px;height:12px;margin-left:4px"
                    v-show="stopFlag"
                    @click="thirdDown(item2, index2, index, index1)"
                  />
                </div>
                <div style="width:20%">
                  <span v-if="item2.isLeaf == 0">否</span>
                  <span v-if="item2.isLeaf == 1">是</span>
                </div>
                <div style="width:20%">{{ item2.courseNum }}</div>
                <div style="width:15%">{{ item2.statusStr }}</div>
                <div style="width:20%;text-align:right">
                  <el-button size="mini" plain @click="gotoDetail(item2)"
                    >详情</el-button
                  >
                  <el-button
                    size="mini"
...
<script lang="ts" src="./platform-classify-list.ts"></script>

  ...
  <div class="select-certificate">
    ...
    >
      ...
      <div class="isSelect" v-show="isType === '2'">
        <el-row :gutter="20">
          <el-col style="text-align: right" :span="4"> 证书选择 </el-col>
          <el-col :span="12">
        ...
        <div v-if="form2.certificateName">
          <el-row :gutter="20">
            <el-col style="text-align: right" :span="4"> 证书名称 </el-col>
            <el-col :span="12">
          ...
          <el-row :gutter="20">
            <el-col style="text-align: right" :span="4"> 证书编码 </el-col>
            <el-col :span="12">
              <div style="font-size: 14px; color: #909399">
          ...
          <el-row :gutter="20">
            <el-col style="text-align: right" :span="4"> 证书内容 </el-col>
            <el-col :span="12">
              <div style="font-size: 14px; color: #909399">
          ...
          <el-row :gutter="20">
            <el-col style="text-align: right" :span="4"> 等级 </el-col>
            <el-col :span="12">
              <div style="font-size: 14px; color: #909399">
                {{ gradeStr }}
              </div>
          ...
          <el-row :gutter="20">
            <el-col style="text-align: right" :span="4"> 类型 </el-col>
            <el-col :span="12">
              <div style="font-size: 14px; color: #909399">
                {{ typeStr }}
              </div>
          ...
          <el-row :gutter="20">
            <el-col style="text-align: right" :span="4"> 性质 </el-col>
            <el-col :span="12">
              <div style="font-size: 14px; color: #909399">
                {{ natureStr }}
              </div>
          ...
          <el-row :gutter="20">
            <el-col style="text-align: right" :span="4"> 发放单位 </el-col>
            <el-col :span="12">
              <div style="font-size: 14px; color: #909399">

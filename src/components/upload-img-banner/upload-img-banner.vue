<template>
  ...
  >
    ...
    >
      <div v-if="noteFlag !== 1">
        <div v-if="imageUrl" class="img-box">
          ...
          <div class="img-del" @click.stop="delImg">
            <i
              style="font-size: 20px;cursor: pointer;margin-top: 50px"
      ...
      <div v-if="noteFlag == 1">
        <div v-if="imageUrl" class="img-box">
          <img :src="imageUrl" class="avatar-apply" />
          <div class="img-del" @click.stop="delImg">
            <i
              style="font-size: 20px;cursor: pointer;margin-top: 70px"
              class="el-icon-delete"
            ></i>
          </div>
        </div>
...
@Component
export default class UploadImgAdvert extends Vue {
  @Prop({
    type: Number,
    required: true,
    default: 1

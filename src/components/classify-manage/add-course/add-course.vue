  ...
  <div>
    ...
    <div class="mt-10">
      ...
      >
        ...
        <el-table-column label="课程类型" min-width="100px">
          <template slot-scope="scope">
            {{ scope.row.courseTypeName }}
          </template>
        </el-table-column>
        <el-table-column label="讲师" min-width="100px">
          <template slot-scope="scope">
    ...
    <div slot="footer" class="text-center mt-30">
      ...
      <el-button size="mini" type="primary" @click="save"
        >确定<span v-if="choosedCourseList.length > 0"
          >({{ choosedCourseList.length }})</span
        ></el-button
      >
    </div>
  </div>

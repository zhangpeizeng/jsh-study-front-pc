<template>
  <div>
    ...
    >
      ...
      <el-table-column label="所属组织" header-align="center" min-width="160px"
        ><template slot-scope="scope">
    ...
    <div slot="footer" class="text-center mt-30">
      ...
      <el-button size="mini" type="primary" @click="submit"
        >确定<span v-if="chooseTeacherList.length > 0"
          >({{ chooseTeacherList.length }})</span
        ></el-button
      >
    </div>
  </div>
</template>
<script lang="ts" src="./add-counselor.ts"></script>
